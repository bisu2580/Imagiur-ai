...
const Signup = () => {
  ...
  if (showVerificationMessage) {
    return (
      <div className="bg-gray-900/75 rounded-3xl shadow-lg overflow-hidden flex max-w-4xl w-full mx-auto mt-10 mb-6 border border-blue-500/30">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 mt-6">
              ...
              <button
                ...
                className="w-full text-gray-400 underline text-sm hover:text-gray-300"
              >
                Back to Sign Up
              </button>
            </div>
        ...
        >
          ...
          <form className="space-y-4 relative z-10" onSubmit={handleSubmit}>
            ...
            >
              ...
              {isLoading ? <ClipLoader color="#afa3a3" /> : null}
            </button>
          </form>
